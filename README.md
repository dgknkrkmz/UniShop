# 🛒 UniShop | Android E-Ticaret Uygulaması – TechCareer.net Jetpack Compose Bootcamp Final Project

Bu proje, **Kotlin** programlama dili ve modern Android geliştirme araçları kullanılarak geliştirilmiş bir **mobil E-Ticaret uygulamasıdır**.  
